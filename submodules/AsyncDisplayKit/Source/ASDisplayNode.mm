...
{
  MutexLocker l(__instanceLock__);
  ASDisplayNodePerformanceMeasurements measurements = {
    .layoutSpecTotalTime = NAN,
    .layoutSpecNumberOfPasses = -1,
    .layoutComputationTotalTime = NAN,
    .layoutComputationNumberOfPasses = -1
  };
