...
open class NavigationBar: ASDisplayNode {
        ...
        if let item = self.item {
            ...
            if needsLeftButton {
                ...
                if let backTitle = backTitle {
                    ...
                    // Улучшаем accessibility для VoiceOver
                    self.backButtonNode.accessibilityLabel = backTitle
                    self.backButtonNode.accessibilityHint = self.presentationData.strings.back
    ...
    public init(presentationData: NavigationBarPresentationData) {
        ...
        // Улучшаем accessibility для кнопки "Назад"
        self.backButtonNode.isAccessibilityElement = true
        self.backButtonNode.accessibilityTraits = .button
        self.backButtonNode.shouldGroupAccessibilityChildren = true
